...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("/Users/lqyyy/Desktop/permanent/code/github/pseudo-maoyan-dubbo/guns-user/src/main/java");//这里写你自己的java目录
        ...
        dsc.setPassword("");
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/guns_rest?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=CONVERT_TO_NULL");
        ...
        strategy.setInclude(new String[]{"user", "mooc_user_t"});
